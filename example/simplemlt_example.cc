...
int main(int argc, char **argv) {
    ...
    scene.addSphere(Sphere(1e5, Vector3(50, 40.8, 1e5), Material(Color(), Color(0.75, 0.75, 0.75), REFLECTION_DIFFUSE)));             // Back
    scene.addSphere(Sphere(1e5, Vector3(50, 40.8, -1e5 + 170), Material(Color(), Color(), REFLECTION_DIFFUSE)));                     // Front
    scene.addSphere(Sphere(1e5, Vector3(50, 1e5, 81.6), Material(Color(), Color(0.75, 0.75, 0.75), REFLECTION_DIFFUSE)));             // Floor
