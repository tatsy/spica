...
protected:
    ...
    virtual void SetUp() {
        scene.add(Sphere(5.0, Vector3D(0.0, 0.0, 0.0)), Material(Color(), Color(0.3, 0.5, 0.7), REFLECTION_DIFFUSE));
        scene.add(Sphere(2.0, Vector3D(0.0, 10.0, 0.0)), Material(Color(15.0, 15.0, 15.0), Color(), REFLECTION_DIFFUSE), true);
    }
