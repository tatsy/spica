...
namespace spica {
    void cornellBox(Scene* scene, Camera* camera, const int width, const int height) {
        ...
        scene->add(Sphere(3.0,  Vector3D( 0.0, -7.0,  0.0)), Material(Color(), Color(0.25, 0.75, 0.25), REFLECTION_DIFFUSE));
        scene->add(Sphere(3.0,  Vector3D(-5.0, -7.0, -5.0)), Material(Color(), Color(0.99, 0.99, 0.99), REFLECTION_SPECULAR));       // Mirror ball
        scene->add(Sphere(3.0,  Vector3D( 5.0, -7.0,  5.0)), Material(Color(), Color(0.99, 0.99, 0.99), REFLECTION_REFRACTION));     // Glass ball
